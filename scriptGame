/* global createCanvas, frameRate, background, line1_x, line1_y, line_length, line2_x, line2_y */

var GameOn, lives, score, yPos_red;
var lines1_x, line1_y, line1_length;
var lines2_x, line2_y, line2_length;
...
function draw() {
  if (GameOn == true) {
    ...
    if (line1_x < 0 - line1_length) {
      ...
      decreaseLength_line1 += 0.2;
      lives--; //lives= lives-1; equal tp lives-=1
    }
